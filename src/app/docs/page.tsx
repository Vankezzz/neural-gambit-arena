    ...
    <div className="min-h-screen bg-gradient-background flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center pt-32 pb-16">
        <div className="flex flex-col items-center gap-8 bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 rounded-2xl p-10 shadow-lg">
          <img src={heroImage} alt="Озадаченный робот" className="w-40 h-40 object-contain mb-2 drop-shadow-xl" />
          <h1 className="text-3xl md:text-5xl font-bold text-center bg-gradient-cyber bg-clip-text text-transparent animate-float">Мы уже разрабатываем</h1>
          <p className="text-lg text-muted-foreground max-w-xl text-center">
            Раздел документации скоро будет доступен.<br />Следите за обновлениями!
          </p>
          <Button 
            variant="cyber" 
            size="lg"
